...
<body>
		...
		<div class="grid">
			<div class="col-1-1"  style="padding-right: 0;">
				<div class="content">
					<fieldset style="width: 50px; margin: 100px auto; background: white;">
						<legend><i class="fa fa-user fa-2x"></i></legend>
						<form action="traitConn.php" method="post">
								<table>
									<tr style="text-align: center;">
										<td class="error" id="erreurConnexionUser">Erreur De Connexion</td>
									</tr>
									<tr>
									...
									<tr>
										<td>
											...
											<input type="reset" value="Annuler" id="resetErreurConnexionUser">
										</td>
									</tr>
								</table>
						</form>
