	...
	<div class="container">
		...
		<div class="grid">
			<div class="col-1-1" style="padding-right:0; ">
				<div class="content">
					<div class="messageErreur success" id="redirectionApresInscription" >
						<span>Inscription réussi ! Vous serez redirigé vers la page de connexion dans <span id="lblCount">&nbsp;&nbsp;</span> secondes</span>
					</div>
				</div>
			</div>
		</div>
